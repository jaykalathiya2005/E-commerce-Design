...
//     // Function to handle card click and navigate to single design page
//     const handleCardClick = (designId) => {
...
//             {/* min-h-screen bg-gray-100 #9CAF88 */}
...
//                                     width: '100%'
//                                 }}
//                                 onClick={() => handleCardClick(cardItem._id)}
//                             >
//                                 <img
...
import React, { useEffect, useState } from 'react'
import { FaRegBookmark, FaRegHeart, FaArrowLeft, FaChevronLeft, FaChevronRight, FaDownload, FaShare } from 'react-icons/fa'
import { useSnackbar } from 'notistack';
import { useDispatch, useSelector } from 'react-redux';
import { getAlldesign } from '../Redux/Slice/design.slice';
import { IMAGE_URL } from '../Utils/baseUrl';
